...
exports.auditRoutes.use((0, authorize_1.authorize)('owner'));
exports.auditRoutes.get('/', (0, validate_1.validate)({ query: schemas_1.auditSchemas.list }), (0, asyncHandler_1.asyncHandler)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, page, limit, skip, query, _b, items, total;
